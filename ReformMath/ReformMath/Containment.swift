...
public func inside(_ point: Vec2d, circle: Circle2d, epsilon: Double = 0) -> Bool
{
    return distance(point: point, point: circle.center) < circle.radius + epsilon
}

public func inside(_ point: Vec2d, arc: Arc2d, epsilon: Double = 0) -> Bool
{
    return distance(point: point, point: arc.center) < arc.radius + epsilon && inside(angle(point-arc.center), range: arc.range)
}

public func inside(_ point : Vec2d, triangle: Triangle2d, epsilon : Double = 0) -> Bool
{
...
public func inside(_ point: Vec2d, aabb: AABB2d, epsilon: Double = 0) -> Bool {
    return aabb.outCode(point, epsilon: epsilon) == .Inside
}


public func inside(_ angle: Angle, range: AngleRange) -> Bool {
